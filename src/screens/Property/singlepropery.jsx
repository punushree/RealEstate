      ...
      <div class="container single">
        <div class="wrapper row">
          ...
          <div class="details col-md-6">
            ...
            <div class="rating">
              <span class="review-no">{locale.label.contactName} </span>
              {propertyData?.contactName}
            </div>
            <h4 class="price">
              {" "}
              {locale.label.price} <span>{propertyData?.price}</span>
            </h4>

            <p class="vote">
              <strong>{locale.label.type}</strong> {propertyData?.type}
              <strong></strong>
            </p>
            <p class="vote">
              <strong>{locale.label.contact}</strong>{" "}
              {propertyData?.phoneNumber?.mobile}
              <strong></strong>
            </p>
